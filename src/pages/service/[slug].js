        ...
        <div>
            ...
            <main className="pt-20 pb-16 lg:pt-24 lg:pb-24 bg-white dark:bg-gray-900">
                <div className="mx-auto max-w-7xl ">
                    <article className="mx-auto w-full px-2 md:px-12">
                        ...
                        <div className='bg-[url(http://profiles.sulekha.com/mstore/40410510/albums/default/thumbnailfull/ac-repair-services.jpg)] bg-cover text-white overflow-hidden w-full rounded-2xl'>
                            <div className='w-full backdrop-brightness-50 px-6 py-6 '>
                                ...
                                <p className='mt-2 text-xs md:text-base w-5/6'>Looking for reliable AC repair services in Supaul? Look no further! Our team of experienced technicians is available to provide you with top-notch repair and maintenance services for all types of AC units.</p>
                                    ...
                                    <div>
                                        ...
                                        <div className='grid grid-cols-2 gap-6 my-8'>
                                            <div className='bg-blue-700 rounded-full py-4 flex justify-center'>
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 stroke-white mr-2">
                                            ...
                                            <div className='border border-blue-700 border-2 rounded-full py-4 flex justify-center'>
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 stroke-blue-700 mr-2">
