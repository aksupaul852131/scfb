    ...
    return (
        <>
            ...
            <div className='bg-[#efefef]'>
                <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8 pt-32 pb-24 font-['Poppins']">
                    ...
                    <div className=''>
                        ...
                        <p className="text-center mt-2">here you can search anything repair service in supaul</p>

                        <div className='flex justify-center'>
                            <div className='bg-white shadow-lg border py-4 px-8 rounded-full w-4/5 m-6 md:mt-10 mx-2 flex'>
            ...
            <div className="bg-white">
                ...
                <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8 pt-32 pb-24 font-['Poppins']">
                    <h2 className="text-center text-2xl font-semibold">Select Your Service</h2>
