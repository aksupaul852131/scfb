                    ...
                    <div className="-mx-4 flex flex-wrap">
                        <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
                            <div className="mb-10 w-full">
                                <h4 className="mb-4 text-1xl font-semibold">Smart Care</h4>
                                <p className="text-body-color mb-7 text-base">
                                    Smart Care Providing Doorstep Home Appliances Repair Services In Supaul
                                </p>
                                <p className="mt-8 text-dark flex items-center text-sm font-medium">
                                    ...
                                    <span><Link href="tel:+918825105519" className="hover:text-blue-700">+91 8825105519</Link></span>
                                </p>
                            </div>
                        </div>
                        <div className="w-full px-4 sm:w-1/2 lg:w-2/12">
                            <div className="mb-10 w-full">
                                <h4 className="text-dark mb-2 text-lg font-semibold">Resources</h4>
                                <ul>
                                    <li>
                                        <Link
                                            href="javascript:void(0)"
                                            className="text-body-color hover:text-blue-700 mb-2 inline-block text-base leading-loose"
                                        >
                                            Development
                                        </Link>
                                    </li>
                        ...
                        <div className="w-full px-4 sm:w-1/2 lg:w-2/12">
                            <div className="mb-10 w-full">
                                <h4 className="text-dark mb-2 text-lg font-semibold">Company</h4>
                                <ul>
                                    <li>
                                        <Link
                                            href="/page/about-us"
                        ...
                        <div className="w-full px-4 sm:w-1/2 lg:w-2/12">
                            <div className="mb-10 w-full">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <Link
                                            href="https://play.google.com/store/apps/details?id=com.smartcare.supaul"
                                            className="text-body-color hover:text-blue-700 mb-2 inline-block text-base leading-loose"
                                        >
                                            Download App
                                        </Link>
                        ...
                        <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
                            <div className="mb-10 w-full">
                                ...
                                <div className="mb-6 flex items-center">
                                    <Link
                                        href="https://www.facebook.com/smartcaresupaul"
                                        className="text-dark hover:bg-blue-700 hover:border-primary mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5] hover:text-white sm:mr-4 lg:mr-3 xl:mr-4"
                                    >
                                        <svg
                                            width={8}
                                            height={16}
                                    ...
                                    <Link
                                        href="https://twitter.com/SmartCareSupaul"
                                        className="text-dark hover:bg-blue-700 hover:border-primary mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5] hover:text-white sm:mr-4 lg:mr-3 xl:mr-4"
                                    >
                                        <svg
                                            width={16}
                                    ...
                                    <Link
                                        href="https://www.youtube.com/@smartcare-servicecentersup9750"
                                        className="text-dark hover:bg-blue-700 hover:border-primary mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5] hover:text-white sm:mr-4 lg:mr-3 xl:mr-4"
                                    >
                                        <svg
                                            width={16}
                                    ...
                                    <Link
                                        href="https://www.linkedin.com/in/smart-care-b7a13b262/"
                                        className="text-dark hover:bg-blue-700 hover:border-primary mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5] hover:text-white sm:mr-4 lg:mr-3 xl:mr-4"
                                    >
                                        <svg
                                            width={14}
                                ...
                                <p className="text-body-color text-base">© 2023 SmartCare</p>
                            </div>
                        </div>
                    </div>
                </div>
