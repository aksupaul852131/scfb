            ...
            <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8 py-12 md:pt-16 font-['Poppins']">
                ...
                <div className="mt-8 mx-auto grid-cols-3 grid md:grid-cols-6 content-center justify-center justify-items-center h-24">
                    <div className='justify-center relative'>
                        <span className="absolute top-4 right-0 animate-ping inline-flex w-2 h-2 rounded-full bg-[#F52E39] opacity-75"></span>
                    ...
                    <div className='justify-center relative'>
                        <span className="absolute top-4 right-5 animate-ping inline-flex w-2 h-2 rounded-full bg-white lg:bg-[#F52E39] opacity-75"></span>
                        <Image className='mt-2 hover:bg-blue-100 w-20' src='/brand/mi.svg' alt='hero' width='75' height='50' />
                    </div>
